...
date_time_data dateTimeData[BLE_MAX_PERIPHERALS];
...
//      static int imuCount = 4;
      ...
      timeCharacteristics[i].readValue( dateTimeData[i].bytes, sizeof dateTimeData[i].bytes );
      if ( debugBool ) {
        Serial.println("printing orient values for board number: ");
        Serial.println(i);
        Serial.println("init year: ");
        Serial.println(dateTimeData[i].dateTime.year);
        Serial.println("init month: ");
        Serial.println(dateTimeData[i].dateTime.month);
        Serial.println("init day: ");
        Serial.println(dateTimeData[i].dateTime.day);
        Serial.println("init hour: ");
        Serial.println(dateTimeData[i].dateTime.hours);
        Serial.println("init minutes: ");
        Serial.println(dateTimeData[i].dateTime.minutes);
        Serial.println("init seconds: ");
        Serial.println(dateTimeData[i].dateTime.seconds);
        Serial.println("init milliseconds: ");
        Serial.println(dateTimeData[i].dateTime.milliseconds);
      }    
    }
